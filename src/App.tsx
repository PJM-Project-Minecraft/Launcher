...
function PlayButton({ state }: { state: LauncherState }) {
  ...
  return (
    <button className="launch-button" onClick={() => void action("play")} disabled={!state.hasProfile || state.isSyncing || state.profileDelivery.phase === "syncing" || state.launcherDelivery.mandatory}>
